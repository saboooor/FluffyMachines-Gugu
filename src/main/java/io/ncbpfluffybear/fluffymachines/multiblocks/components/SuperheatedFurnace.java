        ...
        new BlockMenuPreset(getId(), "&cFoundry") {
            ...
            public void newInstance(@Nonnull BlockMenu menu, @Nonnull Block b) {
                if (StorageCacheUtils.getData(b.getLocation(), "stored") == null) {
                    ...
                    menu.replaceExistingItem(4, new CustomItemStack(Material.GUNPOWDER, "&6Dust Available: &e0", "&a> &eLeft Click &ahere to retrieve 1", "&a> &eRight Click &ahere to retrieve 64"));
                    menu.replaceExistingItem(7, new CustomItemStack(Material.IRON_INGOT, "&6Ingots Available: &e0", "&a> &eLeft Click &ahere to retrieve 1", "&a> &eRight Click &ahere to retrieve 64"));
